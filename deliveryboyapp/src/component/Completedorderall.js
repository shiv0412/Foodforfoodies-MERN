...
const Completedorderall = (props) => {
  ...
  useEffect(async () => {
    ...
    data.reverse();
    var active = data.filter((element) => {
      return (
        element.d_email == props.deliveryboydata.email &&
              ...
              <div class="row row_handler_order" style={{ paddingBottom: "0" }}>
                ...
                <div class="col-sm my-col-sm handler">
                  <div className="select_holder">
                    ...
                    <br /> */}
                    <button className="update_button_orders">Delete</button>
                  </div>
                </div>
                <div
                  style={{
...
export default Completedorderall;
